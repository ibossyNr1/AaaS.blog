#!/bin/bash
# Deploy Microsoft Ads MCP skill to AntiGravity

SKILL_NAME="microsoft-ads-mcp"
TARGET_DIR="$HOME/.gemini/skills/$SKILL_NAME"

echo "🚀 Deploying Microsoft Ads MCP skill..."
...
echo "✅ Microsoft Ads MCP skill deployed to: $TARGET_DIR"
echo ""
echo "📋 Next steps:"
echo "1. cd $TARGET_DIR"
echo "2. cp .env.template .env"
echo "3. Add your Microsoft Advertising credentials to .env"
echo "4. Run ./test.sh to verify setup"
echo "5. Run ./install.sh to install dependencies"
echo ""
echo "🚀 Next: Creating LinkedIn Ads MCP skill..."
