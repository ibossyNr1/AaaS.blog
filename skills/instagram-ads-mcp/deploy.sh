#!/bin/bash
# Deploy Instagram Ads MCP skill to AntiGravity

SKILL_NAME="instagram-ads-mcp"
TARGET_DIR="$HOME/.gemini/skills/$SKILL_NAME"

echo "🚀 Deploying Instagram Ads MCP skill..."
...
echo "✅ Instagram Ads MCP skill deployed to: $TARGET_DIR"
echo ""
echo "📋 Next steps:"
echo "1. cd $TARGET_DIR"
echo "2. cp .env.template .env"
echo "3. Add your Facebook/Instagram API credentials to .env"
echo "4. Run ./test.sh to verify setup"
echo "5. Run ./install.sh to install dependencies"
echo ""
echo "🚀 Next: Creating Twitter/X Ads MCP skill..."
