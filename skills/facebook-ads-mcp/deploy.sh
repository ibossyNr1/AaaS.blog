#!/bin/bash
# Deploy Facebook Ads MCP skill to AntiGravity

SKILL_NAME="facebook-ads-mcp"
TARGET_DIR="$HOME/.gemini/skills/$SKILL_NAME"

echo "🚀 Deploying Facebook Ads MCP skill..."
...
echo "✅ Facebook Ads MCP skill deployed to: $TARGET_DIR"
echo ""
echo "📋 Next steps:"
echo "1. cd $TARGET_DIR"
echo "2. cp .env.template .env"
echo "3. Add your Facebook Ads credentials to .env"
