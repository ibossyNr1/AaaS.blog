...
description: "Query official Microsoft documentation to understand concepts, find\
  \ tutorials, and learn how services work. Use for Azure, .NET, Microsoft 365, Windows,\
  \ Power Platform, and all Microsoft technologies. Get accurate, current information\
  \ from learn.microsoft.com and other official Microsoft websites\u2014architecture\
  \ overviews, quickstarts, configuration guides, limits, and best practices. Use\
