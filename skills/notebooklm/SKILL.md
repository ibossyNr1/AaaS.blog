...
## 🎯 Triggers
- Use this skill when you need to use this skill to query your google notebooklm notebooks directly from claude code for source-grounded, citation-backed answers from gemini. browser automation, library management, persistent auth. drastically reduced hallucinations through document-only responses.

## ⚡ Quick Start (Self-Check)
Before running logic, verify readiness:
- [ ] Run `bash ~/.gemini/skills/notebooklm/test.sh`.
