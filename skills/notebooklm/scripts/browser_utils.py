...
class BrowserFactory:
    ...
    @staticmethod
    def launch_ephemeral_context(playwright: Playwright, headless: bool = True) -> (any, BrowserContext):
        """
        Launch an ephemeral context with cookies injected from state.json.
