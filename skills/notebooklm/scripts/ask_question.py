...
def ask_notebooklm(question: str, notebook_url: str, headless: bool = True) -> str:
    ...
    try:
        # Create temp dir for stateless persistent context
        temp_dir = tempfile.mkdtemp()
        
        # Start playwright
        playwright = sync_playwright().start()

        # Launch persistent context in temp dir (avoids locks, mimics fresh profile)
        # BrowserFactory will inject cookies from shared STATE_FILE
