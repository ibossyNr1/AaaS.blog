#!/bin/bash
# Deploy Twitter/X Ads MCP skill to AntiGravity

SKILL_NAME="twitter-x-ads-mcp"
TARGET_DIR="$HOME/.gemini/skills/$SKILL_NAME"

echo "🚀 Deploying Twitter/X Ads MCP skill..."
...
echo "✅ Twitter/X Ads MCP skill deployed to: $TARGET_DIR"
echo ""
echo "📋 Next steps:"
echo "1. cd $TARGET_DIR"
echo "2. cp .env.template .env"
echo "3. Add your Twitter/X API credentials to .env"
echo "4. Run ./test.sh to verify setup"
echo "5. Run ./install.sh to install dependencies"
echo ""
echo "🚀 Next: Creating TikTok Ads MCP skill..."
