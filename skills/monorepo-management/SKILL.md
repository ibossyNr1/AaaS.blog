...
description: Manage monorepo architectures with tools like Nx, Turborepo, Lerna, or Rush. Use when setting up monorepos, optimizing build pipelines, managing dependencies across packages, or implementing workspace conventions.
version: 1.0.0
dependencies: ["nodejs", "git", "npm"]
---
